...
function inspect(root, targetFile, options) {
    ...
    return dockerFile
        ...
        return analyzeDynamically(targetImage, dockerfileAnalysis, getDynamicAnalysisOptions(options));
    });
}
...
function analyzeStatically(targetImage, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const manifestFiles = [];
        try {
            const staticAnalysis = yield analyzer.analyzeStatically(targetImage, staticAnalysisOptions);
            const parsedAnalysisResult = parseAnalysisResults(targetImage, staticAnalysis, dockerfileAnalysis);
            const dependenciesTree = yield buildTree(targetImage, parsedAnalysisResult.type, parsedAnalysisResult.depInfosList, parsedAnalysisResult.targetOS);
            const analysis = {
            ...
            const response = Object.assign(Object.assign({}, response_builder_1.buildResponse(runtime, analysis, dockerfileAnalysis, manifestFiles, staticAnalysisOptions)), { hashes: [] });
