...
describe("L00_Demo_Tests", function () {
  it("L00_1_T01:Patient Not Found", async function () {
    ...
    const result = await Client.L00_1_GetPatientFullNameAndAddress(
      baseUrl,
...
`;
  ...
  it("L00_1_T03:Patient with a full conformant us-core race extension", async function () {
    ...
    const result = await Client.L00_2_GetUSCoreRace(
      baseUrl,
      PatientIdentifierSystem,
      PatientIdentifierValue
    );
  ...
  it("L00_1_T04:Patient with several us-core condition resources", async function () {
    ...
    const result = await Client.L00_3_GetConditions(
      baseUrl,
      PatientIdentifierSystem,
      PatientIdentifierValue
    );
    const match =
      "ACTIVE|CONFIRMED|PROBLEM LIST ITEM|442311008:LIVEBORN BORN IN HOSPITAL|2020-08-10\nACTIVE|CONFIRMED|PROBLEM LIST ITEM|69347004:NEONATAL JAUNDICE (DISORDER)|2020-08-10\n";
    const r1 = match;
    const r2 = result;
    expect(r1.toUpperCase()).toEqual(r2.toUpperCase());
  });
  ...
  it("L00_1_T05:Create US Core R4 Conformant Allergy Resource", async function () {
    ...
    const result = await Client.L00_4_CreateUSCoreAllergyIntollerance(
      baseUrl,
      PatientIdentifierSystem,
      PatientIdentifierValue,
      ClinicalStatusCode,
  ...
  it("L00_1_T07:Get Lab Results from IPS Document", async function () {
    ...
    const result = await Client.L00_5_GetLabResultsFromIPS(
      baseUrl,
      PatientIdentifierSystem,
      PatientIdentifierValue
    );
    ...
    match +=
      "945-6:C Ab [Presence] in Serum or Plasma|2015-10-10T09:35:00+01:00|final|10828004:Positive\n";
    match +=
      "1018-1:E Ab [Presence] in Serum or Plasma|2015-10-10T09:35:00+01:00|final|10828004:Positive\n";
    match +=
      "1156-9:little c Ab [Presence] in Serum or Plasma|2015-10-10T09:35:00+01:00|final|260385009:Negative\n";
    match +=
      "17856-6:Hemoglobin A1c/Hemoglobin.total in Blood by HPLC|2017-11-10T08:20:00+01:00|final|7.5 %\n";
    match +=
